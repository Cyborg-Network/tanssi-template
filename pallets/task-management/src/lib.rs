...
use {
    frame_support::{pallet_prelude::ConstU32, sp_runtime::RuntimeDebug, BoundedVec},
    parity_scale_codec::{Decode, Encode, MaxEncodedLen},
    scale_info::{prelude::vec::Vec, TypeInfo},
    sp_core::hash::H256,
};
...
pub mod pallet {
    use {
        super::*,
        frame_support::{dispatch::DispatchResultWithPostInfo, pallet_prelude::*},
        frame_system::{pallet_prelude::*, WeightInfo},
        pallet_edge_connect::{AccountWorkers, Pallet as PalletEdgeConnect, WorkerClusters},
    };
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn submit_completed_task(
            ...
            let random_index =
                (sp_io::hashing::blake2_256(&ver.encode())[0] as usize) % workers.len();
